...
**Trading Persona** A multi-dimensional behavioral identity derived from real trading actions.

**Read-Only API** A secure exchange API permission allowing data viewing only.

**Multi-Dimensional Trading Data** Combined personal live trading data and public macro/on-chain data.

**LLA / LLAx** The dual-token system of the LinkLayerAI ecosystem.
